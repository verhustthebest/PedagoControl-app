...
export type ParentJournal={student:{public_id:string;first_name:string;last_name:string};journal_date:string;control_status:'submitted'|'validated'|'correction_requested';lessons:ParentLesson[];acknowledgement:ParentAcknowledgement|null}
