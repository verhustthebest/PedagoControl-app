...
router.post('/parental/schools/:schoolId/attachment-requests', ...decision, (0, validate_middleware_1.validate)({ params: schemas_1.schoolParams, body: schemas_1.attachmentCreateBody }), attachment_request_controller_1.create);
