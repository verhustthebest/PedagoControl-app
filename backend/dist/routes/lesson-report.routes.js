...
router.post('/teacher/reports', ...teachers, lesson_report_controller_1.submitTeacherReport);
router.get('/prefet/reports/pending', ...prefects, lesson_report_controller_1.prefetReportsPending);
router.patch('/prefet/reports/:id/decision', ...prefects, lesson_report_controller_1.decidePrefetReport);
