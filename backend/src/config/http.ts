...
export function corsOptions(environment = process.env.NODE_ENV, configured = process.env.FRONTEND_URLS ?? process.env.FRONTEND_URL, csrfHeader = process.env.CSRF_HEADER_NAME || 'X-CSRF-Token'): CorsOptions {
