import{Router}from'express';import{addDocument,decide,disable,index,removeDocument,show}from'../controllers/attachment-request.controller';import{authenticateBearerToken,requirePermission,requireSchoolScope}from'../middleware/auth.middleware';import{validate}from'../middleware/validate.middleware';import{attachmentDecisionBody,attachmentDisableBody,attachmentDocumentBody,attachmentDocumentParams,attachmentRequestParams,attachmentRequestQuery,schoolParams}from'../validation/schemas';
