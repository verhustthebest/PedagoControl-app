...
router.get('/parental/schools/:schoolId/students/:studentId', ...access, validate({ params: studentParams }), showStudent)
router.put('/parental/schools/:schoolId/students/:studentId', ...access, validate({ params: studentParams, body: updateStudentBody }), updateStudentHandler)
router.patch('/parental/schools/:schoolId/students/:studentId/tracking', ...access, validate({ params: studentParams, body: trackingBody }), updateStudentTracking)
