...
export const schoolParams = z.object({ schoolId: id }).strict()
export const studentParams = z.object({ schoolId: id, studentId: id }).strict()
export const guardianParams = z.object({ schoolId: id, guardianId: id }).strict()
export const guardianLinkParams = z.object({ schoolId: id, studentId: id, guardianId: id }).strict()
export const invoiceParams = z.object({ schoolId: id, invoiceId: id }).strict()
...
const studentFields = {
  ...
  status: z.enum(['active', 'inactive']).optional(), academic_year_class_id: id.optional(),
}
